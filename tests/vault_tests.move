...
module deri::vault_tests {
    ...
    fun test_deposit_vault_should_work() {
        ...
        assert!(vault::get_balance(vault_object, 0) == (deposit_amount * 2 as u256));
    }
    ...
    fun test_redeem_vault_should_work() {
        ...
        assert!(vault::get_balance(vault_object, 0) == ((deposit_amount - redeem_amount) as u256));
        assert!(primary_fungible_store::balance(vault_addr, b0_metadata) == (deposit_amount - redeem_amount));
