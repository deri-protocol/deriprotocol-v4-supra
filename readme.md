...
{
      "type": "address",
      "value": "0x74e53bc85464b078cb44a6ae1f9d42ec257e576cd4f0147d3f4548283e850350"
}
```
...
```shell
supra move tool run --function-id '0x74e53bc85464b078cb44a6ae1f9d42ec257e576cd4f0147d3f4548283e850350::gateway::initialize' --url https://rpc-testnet.supra.com --profile deri1
```

### 2. Add b token (USDC)
- Get vault address:
```shell
supra move tool view --function-id '0x74e53bc85464b078cb44a6ae1f9d42ec257e576cd4f0147d3f4548283e850350::vault::vault_address' --args address:0xdb0a9c771aad8de01c250de6b4230c16c7a0475f333c8da2e68040c9ca5e704e --url https://rpc-testnet.supra.com
```

- Add b token
```shell
supra move tool run --function-id '0x74e53bc85464b078cb44a6ae1f9d42ec257e576cd4f0147d3f4548283e850350::gateway::add_b_token' --args address:0xdb0a9c771aad8de01c250de6b4230c16c7a0475f333c8da2e68040c9ca5e704e address:0xcc176ee7ae7d11e3fd24a45ee264292f65925103a683916051ad01a3a5a0c3d4 String:USDCUSD u256:1000000000000000000 --url https://rpc-testnet.supra.com --profile deri1
```

### 3. Set d_chain execution fee per request
```shell
supra move tool run --function-id '0x74e53bc85464b078cb44a6ae1f9d42ec257e576cd4f0147d3f4548283e850350::gateway::set_d_chain_execution_fee_per_request' --args u256:10000 --url https://rpc-testnet.supra.com --profile deri1
```

### 4. Set execution
```shell
supra move tool run --function-id '0x74e53bc85464b078cb44a6ae1f9d42ec257e576cd4f0147d3f4548283e850350::gateway::set_execution_fee' --args u256:11000 u256:14000  u256:11000  u256:10000  u256:11000  --url https://rpc-testnet.supra.com --profile deri1
```
